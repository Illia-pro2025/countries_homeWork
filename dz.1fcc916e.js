...
function onSearch(event) {
    ...
    if (searchQuery.length > 2) fetching(searchQuery);
    (0, _core.notice)({
...
function fetching(searchQuery) {
    (0, _countriesDefault.default)(searchQuery).then((response)=>{
        if (!response.ok) throw new Error(response.status);
        return response.json();
    }).then((data)=>{
        let countries = data.data.objects;
        if (countries.length > 10) (0, _core.notice)({
...
function renderCountryInfo(country) {
    ...
    function controleCapital() {
        ...
        if (country.capitals[0].name) capital = country.capitals[0].name;
        return capital;
    }
    function controleLang() {
        let lang = "language is not defined";
        if (languages) lang = languages;
        return lang;
    }
    const markup = `
...
},{"@pnotify/core":"fay4s","./style.css":"bhJkM","@parcel/transformer-js/src/esmodule-helpers.js":"eGQb7","./countries":"2syGS","@pnotify/core/dist/BrightTheme.css":"grIyt","@pnotify/core/dist/PNotify.css":"c4y47"}],"fay4s":[function(require,module,exports,__globalThis) {
var global = arguments[3];
!function(t, e) {
    e(exports);
}(this, function(t) {
...
},{}],"bhJkM":[function() {},{}],"eGQb7":[function(require,module,exports,__globalThis) {
...
},{}],"2syGS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"eGQb7"}],"grIyt":[function() {},{}],"c4y47":[function() {},{}]},["iUuJv","fILKw"], "fILKw", "parcelRequirebe7a", {})
